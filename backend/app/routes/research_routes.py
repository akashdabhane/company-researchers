...
def research_company(
    ...
    try:
        ...
        response = {
            ...
            "tech_stack_data": result.get("tech_stack_data"),
    ...
    def generate():
        try:
            ...
            for event in graph.stream(
                ...
                for node_name, output in event.items():
                    ...
                    friendly_messages = {
                        ...
                        "location": "Researched headquarters address & global footprint...",
                        "tech_stack": "Auditing software frameworks, cloud hosting & AI stack...",
                        "financial": "Evaluating funding history, valuation & pricing models...",
            ...
            response = {
                ...
                "location_data": accumulated_state.get("location_data"),
                "tech_stack_data": accumulated_state.get("tech_stack_data"),
                "financial_data": accumulated_state.get("financial_data"),
